...
export default function LaunchSection() {
  return (
    <section className="w-full h-150 bg-white flex flex-col md:flex-row items-center justify-between gap-4 py-2 px-6 md:px-60 ">
      ...
      >
        ...
        <p className="text-black/50 mt-4 text-sm md:text-base leading-relaxed">
          Launched a plethora of AI LLM based tools like skimming.ai to be
