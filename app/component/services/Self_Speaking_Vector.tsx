    ...
    <div className="container mx-auto px-6 md:px-12 py-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        <div className="h-64 md:h-[550px] overflow-hidden  col-span-2">
          <img
            src="/services/self-speaking.jpg"
            alt="Brand color swatches and design materials"
            className="w-full h-full object-cover"
          />
        </div>

        <IconCard icon="/ex-2.png" label="Graphics" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        <div>
        ...
        <div className="col-span-2">
          <p className="text-black/50 text-lg leading-relaxed mb-8">
            We design high-impact graphics that effectively convey your message
            and capture attention. Whether it&apos;s for digital media, print,
            or advertising, our graphics are crafted to engage and communicate
            clearly. We focus on visual storytelling, ensuring that every design
            element aligns with your brand&apos;s voice and objectives.
          </p>
...
export default Self_Speaking_Vector;
