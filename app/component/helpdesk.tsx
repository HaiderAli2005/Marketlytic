      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 pt-20 pb-24 px-10">
        ...
        <div  className="flex flex-col">
          ...
          <p className="text-[18px] text-black/50 leading-[1.45] max-w-[650px] mb-10">
           Receive rapid responses to frequent inquiries regarding our design solutions, methodologies, and costs. Should you have additional queries, don't hesitate to contact us!
          </p>
...
>
  {[
    ...
    },
    {
      ...
      answer:
        "The cost depends on complexity and scope. Smaller work like logos costs less, while full branding or UI/UX systems are higher investment.",
    },
    {
      question: "What is your revision process?",
      answer:
        "Our revision process involves reviewing your feedback, making necessary adjustments, and presenting updates until you're fully satisfied.",
    },
  ].map((item, index) => (
